...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of silicoin', () => {
      const result = units.getUnit('silicoin');
    ...
    it('gets unit of silicoin using alias', () => {
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('silicoin', 9);

      const result = units.getUnit('silicoin');

      expect(result).toEqual(9);

      units.setUnit('silicoin', 1);
    });
  });
  describe('#setDisplay', () => {
