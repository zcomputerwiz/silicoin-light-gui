...
import { CardHero, Flex, Link } from '@silicoin/core';
import { PlotHero as PlotHeroIcon } from '@silicoin/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Silicoin. '
              }
              <Link
                target="_blank"
