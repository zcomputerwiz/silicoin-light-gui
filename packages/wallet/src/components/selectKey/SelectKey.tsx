...
import { Button, ConfirmDialog, Flex, Logo, Loading, useOpenDialog, TooltipIcon } from '@silicoin/core';
import {
  Card,
  Typography,
  Container,
          ...
          {isLoading ? (
            ...
            <>
              ...
              <Typography variant="subtitle1">
                <Trans>
                  Welcome to Silicoin. Please log in with an existing key, or create
                  a new key.
                </Trans>
              </Typography>
            </>
