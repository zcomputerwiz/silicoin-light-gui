...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@silicoin/core';
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create Silicoin Asset Token Wallet from Existing TAIL</Trans>}
