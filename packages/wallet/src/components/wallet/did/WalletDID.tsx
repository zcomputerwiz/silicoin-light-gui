...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@silicoin/core';
import {
...
import { mojo_to_silicoin_string } from '../../../util/silicoin';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_silicoin_string(props.balance)} TSIT
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CreateAttest = (props) => {
  ...
  function createAttestPacket() {
    ...
    if (address.substring(0, 12) === 'silicoin_addr://') {
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'silicoin_addr://') {
