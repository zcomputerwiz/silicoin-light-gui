...
import { Loading, ThemeProvider, ModalDialogsProvider, ModalDialogs } from '@silicoin/core';
import { store, api } from '@silicoin/api-react';
import { Wallet, ServiceName } from '@silicoin/api';
